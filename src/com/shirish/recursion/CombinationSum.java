...
public class CombinationSum {
    ...
    private static void findCombinationSum(int index, int target, int[] candidates, List<List<Integer>> result, ArrayList<Integer> oneResult) {
        ...
        if(candidates[index] <= target)
        {
            ...
            findCombinationSum(index, target - candidates[index], candidates, result, oneResult);
